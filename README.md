...
- a *configuration file* giving details like the voices
  ...
  destination audio volume, list of mutable voices for the audio
  tracks etc.

Based on those files the python script -- together with some
open-source command-line software like ffmpeg or fluidsynth --
produces all the destination files either incrementally or altogether.
...
![LilypondToBandVideoConverter phases](https://github.com/prof-spock/LilypondToBandVideoConverter/blob/master/lilytobvc-flow.png)
...
- *[sox][]*: for instrument-specific postprocessing of audio
   files for the audio mix files as well as the mixdown,
   and
...
A longer description is available [here, part1][plan1] and
[here, part2][plan2].  The detailed manual is available [here].
...
[plan1]: https://www.tensi.eu/thomas/music/produce_like_a_nerd/produce-like-a-nerd_1.html
[plan2]: https://www.tensi.eu/thomas/music/produce_like_a_nerd/produce-like-a-nerd_2.html
